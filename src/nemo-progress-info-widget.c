...
#define START_ICON "xapp-media-playback-start-symbolic"
#define STOP_ICON "xapp-media-playback-stop-symbolic"
#define PAUSE_ICON "xapp-media-playback-pause-symbolic"
