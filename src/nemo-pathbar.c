                   ...
                   GtkPositionType  position)
{
    ...
    {
        image = gtk_image_new_from_icon_name ("xapp-pan-start-symbolic", GTK_ICON_SIZE_MENU);
    }
    else
    {
        image = gtk_image_new_from_icon_name ("xapp-pan-end-symbolic", GTK_ICON_SIZE_MENU);
    }
    ...
    if (button_data->image != NULL) {
        switch (button_data->type) {
            ...
            case ADMIN_ROOT_BUTTON:
                icon_name = g_strdup ("xapp-emblem-important-symbolic");
                break;
            case HOME_BUTTON:
            case DESKTOP_BUTTON:
            case XDG_BUTTON:
