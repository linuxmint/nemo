...
static const GtkActionEntry directory_view_entries[] = {
  /* name, stock id, label */  { "New Documents", "xapp-document-new-symbolic", N_("Create New _Document") },
  /* name, stock id, label */  { "Open With", NULL, N_("Open Wit_h"),
				 NULL, N_("Choose a program with which to open the selected item") },
  /* name, stock id */         { "Properties", "xapp-document-properties-symbolic",
  ...
  /* tooltip */                  NULL,
				 G_CALLBACK (action_properties_callback) },
  /* name, stock id */         { "New Folder", "xapp-folder-new-symbolic",
  ...
  /* name, stock id */         { NEMO_ACTION_OPEN_IN_TERMINAL, "xapp-utilities-terminal-symbolic",
  ...
  /* name, stock id */         { NEMO_ACTION_OPEN_AS_ROOT, "xapp-dialog-password-symbolic",
  ...
  /* name, stock id */         { NEMO_ACTION_FOLLOW_SYMLINK, "xapp-go-jump-symbolic",
  ...
  /* name, stock id */         { NEMO_ACTION_OPEN_CONTAINING_FOLDER, "xapp-go-jump-symbolic",
  ...
  /* name, stock id */         { "Cut", "xapp-edit-cut-symbolic",
  ...
  /* name, stock id */         { "Copy", "xapp-edit-copy-symbolic",
  ...
  /* name, stock id */         { "Paste", "xapp-edit-paste-symbolic",
  ...
  /* name, stock id */         { "Paste Files Into", "xapp-edit-paste-symbolic",
 ...
 /* name, stock id */          { "Undo", "xapp-edit-undo-symbolic",
 /* label, accelerator */        N_("_Undo"), "<control>Z",
 /* tooltip */                   N_("Undo the last action"),
                                 G_CALLBACK (action_undo_callback) },
 /* name, stock id */	       { "Redo", "xapp-edit-redo-symbolic",
 ...
 /* tooltip */                   N_("Redo the last undone action"),
  ...
  /* name, stock id */         { NEMO_ACTION_LOCATION_CUT, "xapp-edit-cut-symbolic",
  ...
  /* name, stock id */         { NEMO_ACTION_LOCATION_COPY, "xapp-edit-copy-symbolic",
  ...
  /* name, stock id */         { NEMO_ACTION_LOCATION_PASTE_FILES_INTO, "xapp-edit-paste-symbolic",
  /* label, accelerator */       N_("_Paste Into Folder"), "",
  ...
  /* name, stock id */         { "LocationProperties", "xapp-document-properties-symbolic",
  ...
  /* name, stock id, label */  {NEMO_ACTION_MOVE_TO_DESKTOP, NULL,
				...
				G_CALLBACK (action_move_to_desktop_callback) },
                               {NEMO_ACTION_BROWSE_MOVE_TO, "xapp-document-open-symbolic",
                N_("Browse..."), NULL,
                N_("Browse for a folder to move the selection to"),
                G_CALLBACK (action_browse_for_move_to_folder_callback) },
                               {NEMO_ACTION_BROWSE_COPY_TO, "xapp-document-open-symbolic",
                N_("Browse..."), NULL,
...
real_update_menus (NemoView *view)
{
    ...
    if (app_icon == NULL) {
        app_icon = g_themed_icon_new ("xapp-folder-open-symbolic");
    }
