...
static const GtkActionEntry bookmark_action_entries[] = {
    ...
    { NEMO_ACTION_SIDEBAR_REMOVE,          "list-remove-symbolic", N_("Remove Bookmark"),      NULL, NULL, G_CALLBACK (remove_shortcut_cb)             },
    { NEMO_ACTION_RENAME,                  NULL,                   N_("_Rename Bookmark"),     NULL, NULL, G_CALLBACK (rename_shortcut_cb)             },
