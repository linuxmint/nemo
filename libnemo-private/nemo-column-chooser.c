...
add_buttons (NemoColumnChooser *chooser)
{
	...
	chooser->details->move_up_button = button_new_with_mnemonic ("xapp-go-up-symbolic",
								     _("Move _Up"));
	...
	chooser->details->move_down_button = button_new_with_mnemonic ("xapp-go-down-symbolic",
								       _("Move Dow_n"));
