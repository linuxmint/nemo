...
enum {
    ...
    NEMO_CONTEXT_ITEM_ENABLED_OPEN_WITH =  (1<<0), //0000001
    NEMO_CONTEXT_ITEM_ENABLED_DUPLICATE =  (1<<1), //0000010
    NEMO_CONTEXT_ITEM_ENABLED_LINK =       (1<<2), //0000100
    NEMO_CONTEXT_ITEM_ENABLED_COPY_TO =    (1<<3), //0001000
    NEMO_CONTEXT_ITEM_ENABLED_MOVE_TO =    (1<<4), //0010000
    NEMO_CONTEXT_ITEM_ENABLED_TRASH =      (1<<5), //0100000
    NEMO_CONTEXT_ITEM_ENABLED_DELETE =     (1<<6)  //1000000
};
