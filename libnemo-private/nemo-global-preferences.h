...
enum {
    ...
    NEMO_CONTEXT_ITEM_ENABLED_OPEN_WITH =  (1<<0),
    NEMO_CONTEXT_ITEM_ENABLED_DUPLICATE = (1<<1),
    NEMO_CONTEXT_ITEM_ENABLED_LINK = (1<<2),
    NEMO_CONTEXT_ITEM_ENABLED_COPY_TO = (1<<3),
    NEMO_CONTEXT_ITEM_ENABLED_MOVE_TO = (1<<4),
    NEMO_CONTEXT_ITEM_ENABLED_TRASH = (1<<5),
    NEMO_CONTEXT_ITEM_ENABLED_DELETE = (1<<6)
};
